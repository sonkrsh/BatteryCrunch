                        ...
                        <ul class="accordion-menu">
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="menu-icon icon-flash_on"></i><span>Make</span><i class="accordion-icon fa fa-angle-left"></i>
                                </a>
                                <ul class="sub-menu">
                                    <li><a href="{{ url('/admin/add-make') }}">Add New</a></li>
                                    <li><a href="{{ url('/admin/show-make') }}">Show All Make</a></li>
                                   
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="menu-icon icon-flash_on"></i><span>Model</span><i class="accordion-icon fa fa-angle-left"></i>
                                </a>
                                <ul class="sub-menu">
                                    <li><a href="{{ url('/admin/add-model') }}">Add New</a></li>
                                    <li><a href="{{ url('/admin/show-model') }}">Show All Model</a></li>
                                   
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="menu-icon icon-flash_on"></i><span>Fuel</span><i class="accordion-icon fa fa-angle-left"></i>
                                </a>
                                <ul class="sub-menu">
                                    <li><a href="{{ url('/admin/add-fuel') }}">Add Fuel</a></li>   
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="menu-icon icon-flash_on"></i><span>BatteryCompany</span><i class="accordion-icon fa fa-angle-left"></i>
                                </a>
                                <ul class="sub-menu">
                                    <li><a href="{{ url('/admin/battery-company') }}">Add Battery</a></li>   
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="menu-icon icon-flash_on"></i><span>BatteryProduct</span><i class="accordion-icon fa fa-angle-left"></i>
                                </a>
                                <ul class="sub-menu">
                                    <li><a href="{{ url('/admin/battery-product') }}">Add Products</a></li>   
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
